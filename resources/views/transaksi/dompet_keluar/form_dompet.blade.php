...
@section('show-dompet_keluar', 'active')
...
<div class="row">
    <div class="col-10 col-m-1">
        <div class="sub_title">DOMPET KELUAR- <span>@if (isset($edit_dompet)) Ubah Dompet Keluar @else Buat Baru @endif</span></div> {{-- Membuat kondisi agar title menyesuaikan dengan halaman yang di akses --}}
    </div>
